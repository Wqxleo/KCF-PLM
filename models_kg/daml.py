...
class DAML(nn.Module):
    ...
    def forward(self, datas):
        ...
        '''
        _, _, uids, iids,ent_user_id,ent_item_id, _, _, user_doc, item_doc = datas
        ...
        # use_fea = self.dropout(use_fea)
        # item_fea = self.dropout(item_fea)
    ...
    def reset_para(self):
        ...
        nn.init.uniform_(self.user_word_embs.weight, -1, 1)
        nn.init.uniform_(self.item_word_embs.weight, -1, 1)
